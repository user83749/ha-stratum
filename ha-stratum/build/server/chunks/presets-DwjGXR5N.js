import { Z as ssr_context } from './exports-DN21j1G3.js';
import 'clsx';
...
const THEME_NEBULA = {
  ...
  colorScheme: "dark",
  visualStyle: "sculpted",
  radius: "md",
  font: { family: "Manrope", size: "md" },
  dense: false,
  animations: true,
  preview: {
...
const THEME_AURORA_BOREALIS = {
  ...
  tokens: {
    ...
    "--color-on": "#2dd4bf",
    "--color-off": "rgba(255, 255, 255, 0.1)"
  },
...
const THEME_SUNSET = {
  ...
  tokens: {
    "--theme-bg-css": "linear-gradient(to bottom right, #ff512f, #dd2476, #3b073c)",
    "--bg": "#000000",
    "--bg-elevated": "#0a0a0a",
    "--surface": "#050505",
    "--surface-rgb": "5 5 5",
...
const THEME_TITANIUM = {
  ...
  tokens: {
    "--theme-bg-css": "linear-gradient(to bottom right, #434343 0%, #111111 60%, #000000 100%)",
    "--bg": "#000000",
    "--bg-elevated": "#09090b",
    "--surface": "#050505",
    "--surface-rgb": "5 5 5",
...
const THEME_SILICON = {
  ...
  tokens: {
    "--theme-bg-css": "radial-gradient(circle at top left, #f9fafb, #f3f4f6, #e5e7eb)",
    "--bg": "#ffffff",
    "--bg-elevated": "#ffffff",
    "--surface": "#ffffff",
    "--surface-rgb": "255 255 255",
...
const THEME_MIDNIGHT = {
  ...
  tokens: {
    "--theme-bg-css": "radial-gradient(ellipse at 30% 40%, #1e1254 0%, #0d0b1e 55%, #07060f 100%)",
    "--bg": "#000000",
    "--bg-elevated": "#09090b",
    "--surface": "#000000",
    "--surface-rgb": "0 0 0",
...
const THEME_OBSIDIAN = {
  ...
  tokens: {
    ...
    "--accent-rgb": "255 255 255",
    "--accent-fg": "#000000",
    "--shadow": "8px 8px 20px rgba(0, 0, 0, 0.9)",
    "--shadow-lg": "16px 16px 40px rgba(0, 0, 0, 1)",
    "--color-on": "#ffffff",
    "--color-off": "#27272a"
  },
...
const THEME_EMBER = {
  ...
  tokens: {
    "--theme-bg-css": "radial-gradient(ellipse at 85% 90%, #5c2a00 0%, #2a1200 45%, #0d0600 100%)",
    "--bg": "#000000",
    "--bg-elevated": "#0a0a0a",
    "--surface": "#000000",
    "--surface-rgb": "0 0 0",
...
const THEME_SNOW = {
  ...
  tokens: {
    ...
    "--accent-rgb": "0 0 0",
    "--accent-fg": "#ffffff",
    "--shadow": "6px 6px 16px rgba(0, 0, 0, 0.04)",
    "--shadow-lg": "12px 12px 32px rgba(0, 0, 0, 0.08)",
    "--color-on": "#000000",
    "--color-off": "#e4e4e7"
  },
...
const THEME_DUSK = {
  ...
  tokens: {
    "--theme-bg-css": "linear-gradient(145deg, #ede8ff 0%, #f5e6ff 50%, #ffe4f0 100%)",
    "--bg": "#ffffff",
    "--bg-elevated": "#f8fafc",
    "--surface": "#ffffff",
    "--surface-rgb": "255 255 255",
...
SYSTEM_THEMES.filter((t) => t.colorScheme === "dark");
SYSTEM_THEMES.filter((t) => t.colorScheme === "light");

export { SYSTEM_THEMES as S, onDestroy as o };
//# sourceMappingURL=presets-DwjGXR5N.js.map
